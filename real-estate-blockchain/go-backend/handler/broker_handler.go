...
// 		CreatedAt: time.Now(),
// 		Role:      "agent",        // 중개인임을 명시
// 		DID:       agentDIDString, // 여기에 생성된 DID 저장
// 	}
...
// 		return
// 	}
// 	fmt.Println("✅ Platform user created:", platformUser.ID, "with DID:", platformUser.DID)
...
// 		return
// 	}
// 	fmt.Println("✅ Wallet registered for:", req.PlatformUsername)
...
// 	// 7. 최종 응답
// 	c.JSON(http.StatusOK, gin.H{
// 		"message": "공인중개사 등록 완료 및 DID 발급완료ㅋㅋ.",
// 		"did":     agentDIDString,
// 	})
// }
